...
- **Softwarestand-Drift korrekt:** Diagnose=0x40, Warnung=0x33 (nicht altes 0x00-Modell).
- **Keine analogen Werte** — die complex 400 ist durchgängig bitcodiert; „Messwerte"
...
- Analoge Mess-/Stellwerte (existieren auf der complex 400 nicht).

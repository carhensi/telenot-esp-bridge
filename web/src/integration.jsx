...
import { Badge, Button, Callout, Checkbox, Field, fmtTime, Icon, Modal, PasswordInput, Toggle } from './ui.jsx';
...
function ScreenMqtt({ ctx }) {
  ...
  const copyHa = () => { navigator.clipboard && navigator.clipboard.writeText(HA_SNIPPET); setHaCopied(true); setTimeout(() => setHaCopied(false), 1600); };

  ...
  projects: [
    ...
    },
    {
      ...
      use: {
        browserName: "chromium",
        viewport: { width: 1280, height: 900 },
        // Retina recording: render at 2× and capture the video at device pixels —
        // otherwise the video is 1× CSS pixels and looks blurry on Mac/iPhone.
        deviceScaleFactor: 2,
        video: { mode: "on", size: { width: 2560, height: 1800 } },
      },
    },
    {
      name: "portrait",
      ...
      use: {
        ...
        isMobile: true,
        hasTouch: true,
        // Capture at device pixels (2×) for a sharp mobile reel.
        video: { mode: "on", size: { width: 804, height: 1748 } },
      },
    },
  ],
  ...
  webServer: [
    {
      ...
      stdout: "pipe",
      stderr: "pipe",
      // Demo sim: fast loop tick → the 242-step scan finishes in ~2 s instead of ~10 s.
      env: { TELENOT_SIM_TICK_MS: "7" },
    },
    {

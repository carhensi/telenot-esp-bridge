...
[![Tests](https://img.shields.io/badge/Tests-136%20passing-brightgreen.svg)](#status)
...
direkt über deren serielle GMS-V6-Schnittstelle ausliest und steuert — als versiegeltes Gerät
...
Dafür ist die GMS-V6-Abdeckung vollständig ([GMS-Coverage](docs/GMS-COVERAGE.md)).
...
<!-- TODO: Screenshots ergänzen (docs/img/ liegt bereit)
<p align="center">
  <img src="docs/img/setup-web.png" width="49%" alt="Setup-Web: Melder-Übersicht">
  <img src="docs/img/homekit.png" width="49%" alt="Apple Home: SecuritySystem-Kachel">
</p>
-->
...
```mermaid
graph LR
    EMA["🚨 Telenot<br/>complex 400"] -- "GMS-V6<br/>RS232 · 9600 8N1" --> FW
...
direkt auf einem 5-€-Chip im Anlagengehäuse.
...
**Phase A + Host-Appliance: abgeschlossen. Phase B/C: Firmware läuft auf Hardware.**
`cargo test --workspace` (136 Tests) grün, `clippy -D warnings` + `fmt` sauber; CI erzwingt
...
| A/B-OTA (SHA-verifiziert) + Bootloader-Rollback | ✅ Code umgesetzt (2026-07); Migrations-Flash am Gerät steht aus |
